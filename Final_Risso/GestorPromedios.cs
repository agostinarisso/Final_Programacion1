...
{
    internal class GestorPromedios
    {
        ...
        public ResultadoPromedio MejorPromedio(Promedio[] promedios)
        {
            ...
            foreach (Promedio promedio in promedios)
            {
                if (promedio.PromedioGeneral > mejorPromedio)
                {
                    ...
                    legajo = promedio.Legajo;
                }
            }
            return new ResultadoPromedio { MejorPromedio = mejorPromedio, Legajo = legajo };
        }
    }
}
